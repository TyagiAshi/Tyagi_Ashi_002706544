...
public class AddPatient extends javax.swing.JPanel {
    ...
    public AddPatient(JPanel userProcessContainer,Sys sys,HomeScreen homeScreen) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblEncounterHist1.setText("Patient Information");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(btnClear, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 124, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void btnPatientSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPatientSaveActionPerformed
        ...
        if(patFound && !txtPatientID.getText().equals("")){
            ...
            //Exsiting patient
            newPerson = sys.getPatDir().getPatientById(Integer.parseInt(txtPatientID.getText())).getPerson();
            ...
            //Show id
            txtPatientID.setText(sys.getPatDir().getPatientById(Integer.parseInt(txtPatientID.getText())).getId()+"");
            ...
            //Create patient
            Patient pat = sys.getPatDir().createPatient(newPerson);

            //Show Message
            JOptionPane.showMessageDialog(this, "Patient added");

            //Show id
            txtPatientID.setText(pat.getId()+"");
        }
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if(!txtPatientID.getText().equals("") && !chkIsPerson.isSelected()){
            
            //Perform search
            populatePatientDetails();
            
        }else if(!txtPatientID.getText().equals("") && chkIsPerson.isSelected()){
