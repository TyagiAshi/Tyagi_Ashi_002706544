...
public class Sys {
    ...
    public void createData(Sys sys){
        ...
        //Create person
        Person per1 = perD.createPerson(1234, " Arpit Jain", util.convertToDate("31-Oct-1996"));
        Person per2 = perD.createPerson(5678, "Rohit Jain", util.convertToDate("20-Dec-1996"));
